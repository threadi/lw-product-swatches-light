...
class Schedules_Base {
	...
	public function get_interval(): string {
		 ...
		 */
		return apply_filters( 'product_swatches_light_schedule_interval', $interval, $instance );
	}
	...
	public function is_enabled(): bool {
		 ...
		 * @since 2.0.0 Available since 2.0.0.
		 *
		 * @param bool $false True if this schedule should NOT be enabled.
		 * @param Schedules_Base $instance Actual object.
		 *
		 * @noinspection PhpConditionAlreadyCheckedInspection
		 */
		if ( apply_filters( 'product_swatches_light_schedule_enabling', $false, $instance ) ) {
			return false;
		}
